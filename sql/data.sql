...
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('multi', '这是一道流体力学多选题1(   )', '[\"我是A\", \"我是B\", \"我是C\", \"我是D\", \"我是E\"]', '[\"A\", \"C\", \"E\"]', 4, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('multi', '这是一道流体力学多选题2(   )', '[\"我是A\", \"我是B\", \"我是C\", \"我是D\", \"我是E\"]', '[\"A\", \"C\", \"E\"]', 4, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('multi', '这是一道流体力学多选题3(   )', '[\"我是A\", \"我是B\", \"我是C\", \"我是D\", \"我是E\"]', '[\"A\", \"C\", \"E\"]', 4, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('multi', '这是一道流体力学多选题4(   )', '[\"我是A\", \"我是B\", \"我是C\", \"我是D\", \"我是E\"]', '[\"A\", \"C\", \"E\"]', 4, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '根据应用需求建立索引是在下列哪个阶段完成1(    )。', '[\"数据库概念结构设计\", \"数据库逻辑结构设计\", \"数据库物理设计\", \"数据库实施与维护\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '以下哪一条属于关系数据库的规范化理论要解决的问题?1(   )。', '[\"如何构造合适的数据库逻辑结构\", \"如果构造合适的数据库物理结构\", \"如何构造合适的应用程序界面\", \"如何控制不同用户的数据操作权限\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '以下哪一条属于关系数据库的规范化理论要解决的问题?1(   )。', '[\"如何构造合适的数据库逻辑结构\", \"如果构造合适的数据库物理结构\", \"如何构造合适的应用程序界面\", \"如何控制不同用户的数据操作权限\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '以下哪一条属于关系数据库的规范化理论要解决的问题?1(   )。', '[\"如何构造合适的数据库逻辑结构\", \"如果构造合适的数据库物理结构\", \"如何构造合适的应用程序界面\", \"如何控制不同用户的数据操作权限\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '以下哪一条属于关系数据库的规范化理论要解决的问题?1(   )。', '[\"如何构造合适的数据库逻辑结构\", \"如果构造合适的数据库物理结构\", \"如何构造合适的应用程序界面\", \"如何控制不同用户的数据操作权限\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '根据应用需求建立索引是在下列哪个阶段完成2(    )。', '[\"数据库概念结构设计\", \"数据库逻辑结构设计\", \"数据库物理设计\", \"数据库实施与维护\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '根据应用需求建立索引是在下列哪个阶段完成3(    )。', '[\"数据库概念结构设计\", \"数据库逻辑结构设计\", \"数据库物理设计\", \"数据库实施与维护\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '根据应用需求建立索引是在下列哪个阶段完成4(    )。', '[\"数据库概念结构设计\", \"数据库逻辑结构设计\", \"数据库物理设计\", \"数据库实施与维护\"]', '[\"A\"]', 2, 0, 0);
INSERT INTO `question`(`Qtype`, `Qstem`, `Qselect`, `Qanswer`, `Subno`, `Qreference`, `Qisdeleted`) VALUES ('select', '以下哪一条属于关系数据库的规范化理论要解决的问题?5(   )。', '[\"如何构造合适的数据库逻辑结构\", \"如果构造合适的数据库物理结构\", \"如何构造合适的应用程序界面\", \"如何控制不同用户的数据操作权限\"]', '[\"A\"]', 2, 0, 0);
